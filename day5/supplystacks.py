...
for instruction in supplystacks:
    ...
    for i in range(move):
        stacks[to].insert(0, str(stacks[fromwhere][0]))
        stacks[fromwhere].pop(0)

print(stacks[1][0] + stacks[2][0] + stacks[3][0] + stacks[4][0] + stacks[5][0] + stacks[6][0] + stacks[7][0] + stacks[8][0] + stacks[9][0]) # SBPQRSCDF